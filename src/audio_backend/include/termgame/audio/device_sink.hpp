...
// term-game — whatever output this build can actually talk to.
//
...
//
// The rest of the audio subsystem lives in include/termgame/audio/ and links no
...
//
// ⚠ There is no #ifdef TERMGAME_WITH_AUDIO anywhere in this file, or in
